...
(1, 'Alex Lanchimba', '0995065906', 'Latacunga', 1, 1),
(2, 'Israel Ashqui', '0987654320', 'Cotopaxi', 1, 1);
...
CREATE TABLE `nivelriesgo` (
  `idnivelriesgo` int(11) NOT NULL,
  `nombrenivelriesgo` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `estado` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `nivelriesgo` (`idnivelriesgo`, `nombrenivelriesgo`,`estado`) VALUES
(1, 'Alto',1),
(2, 'Bajo',1);
...
CREATE TABLE `tiporiesgo` (
  ...
  `nombretiporiesgo` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `tiporiesgodescripcion` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `estado` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `tiporiesgo` (`idtiporiesgo`, `nombretiporiesgo`, `tiporiesgodescripcion`,`estado`) VALUES
(1, 'Deslizamiento','Derrumbe de tierra',1),
(2, 'Volcan','Erupcion volcanica',1);
...
--
-- Estructura de tabla para la tabla `ventas`   --POSIBLE EDITAR *********
--
...
-- Indices de la tabla `nivelriesgo`
--
ALTER TABLE `nivelriesgo`
  ADD PRIMARY KEY (`idnivelriesgo`);



  -- Indices de la tabla `tiporiesgo`
--
...
-- AUTO_INCREMENT de la tabla `nivelriesgo`
--
ALTER TABLE `nivelriesgo`
  MODIFY `idnivelriesgo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;


-- AUTO_INCREMENT de la tabla `tiporiesgo`
--
ALTER TABLE `tiporiesgo`
  MODIFY `idtiporiesgo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
